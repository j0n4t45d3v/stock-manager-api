...
import com.jonatasrocha.stock.inventory.InventoryService;
import com.jonatasrocha.stock.inventory.ProductMovementRepository;
import com.jonatasrocha.stock.inventory.StockStateRepository;
...
public class ProductController extends BaseController {
    ...
    public ProductController(
        ...
        ProductMovementRepository productMovementRepository, InventoryService inventoryService
    ) {
    ...
    public ResponseEntity<Response> create(@RequestBody @Valid ProductRequest request) {
        ...
        this.inventoryService.createInventory(productSaved.getId());
